# Contributing to oxidized-crypto
...
```bash
# 1. Fork and clone
git clone https://github.com/oxidized-mc/crypto.git
cd crypto
...
`oxidized-crypto` is a library crate in the
...
Use `crypto` as the scope for all changes to this crate.
